...
$canOrder	= $user->authorise('core.edit.state', 'com_hwdmediashare.media');
...
<?php foreach($this->items as $i => $item):
        ...
        <tr class="row<?php echo $i % 2; ?>">
                ...
                <td>
                        <div class="fltlft"><span class="editlinktip hasTip" title="<?php echo $this->escape($item->title); ?>::<?php echo $this->escape($item->description); ?>" ><img src="<?php echo $this->getMediaTypeIcon($item); ?>" width="24" /></span></div>
                </td>
                <td>
                        <div class="fltlft"><span class="editlinktip hasTip" title="<?php echo $this->escape($item->title); ?>::<?php echo $this->escape($item->description); ?>" ><img src="<?php echo JRoute::_(hwdMediaShareDownloads::thumbnail($item)); ?>" width="75" /></span></div>
                </td>
                ...
                <td>
                        ...
                        <?php if ($canEdit) : ?>
                                <a href="<?php echo JRoute::_('index.php?option=com_hwdmediashare&task=editmedia.edit&id='.(int) $item->id); ?>">
                ...
                <td class="center">
                        <?php echo $this->getCategories($item); ?>
                </td>
                <td class="order">
                        <?php if ($canChange) : ?>
                                <?php if ($saveOrder) :?>
                                        <?php if ($listDirn == 'asc') : ?>
                                                <span><?php echo $this->pagination->orderUpIcon($i, true, 'media.orderup', 'JLIB_HTML_MOVE_UP', $ordering); ?></span>
                                        ...
                                        <?php elseif ($listDirn == 'desc') : ?>
                                                <span><?php echo $this->pagination->orderUpIcon($i, true, 'media.orderdown', 'JLIB_HTML_MOVE_UP', $ordering); ?></span>
