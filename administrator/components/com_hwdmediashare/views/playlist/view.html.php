...
class hwdMediaShareViewPlaylist extends JViewLegacy {
	...
	protected function addToolBar()
	{
		...
		JToolBarHelper::title($isNew ? JText::_('COM_HWDMS_NEW_PLAYLIST') : JText::_('COM_HWDMS_EDIT_PLAYLIST'), 'hwdmediashare');
	...
	protected function setDocument()
	{
		...
		$document->setTitle($isNew ? JText::_('COM_HWDMS_HWDMEDIASHARE').' '.JText::_('COM_HWDMS_NEW_PLAYLIST') : JText::_('COM_HWDMS_HWDMEDIASHARE').' '.JText::_('COM_HWDMS_EDIT_PLAYLIST'));
