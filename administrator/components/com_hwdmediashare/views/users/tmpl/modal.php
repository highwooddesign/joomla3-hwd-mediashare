<?php
/**
 * @version    SVN $Id: modal.php 425 2012-06-28 07:48:57Z dhorsfall $
 * @package    hwdMediaShare
 * @copyright  Copyright (C) 2011 Highwood Design Limited. All rights reserved.
 * @license    GNU General Public License http://www.gnu.org/copyleft/gpl.html
 * @author     Dave Horsfall
 * @since      08-Dec-2011 17:49:06
 */
...
$function       = JRequest::getCmd('function', 'jSelectUserChannel_jform_element_id');
?>
                ...
                <tbody>
                        <?php foreach($this->items as $i => $item):
                                ...
                                <tr class="row<?php echo $i % 2; ?>">
                                        <td>
                                                <span class="editlinktip hasTip" title="<?php echo $this->escape($item->name); ?>::<?php echo $this->escape($item->description); ?>" >
