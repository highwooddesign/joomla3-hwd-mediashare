...
class hwdMediaShareViewUsers extends JViewLegacy {
	...
	protected function addToolBar()
	{
		...
		JToolBarHelper::title(JText::_('COM_HWDMS_USER_CHANNELS'), 'hwdmediashare');
	...
	protected function setDocument()
	{
		...
		$document->setTitle(JText::_('COM_HWDMS_HWDMEDIASHARE').' '.JText::_('COM_HWDMS_USER_CHANNELS'));
	}
	/**
	...
	public function getPublish( &$row, $type, $i )
	{
                ...
                if ($type == "created")
                {
                        $state = $row->$type ? 'publish' : 'expired';
                ...
                {
                        $state = 'unpublish';
                        $alt  = JText::_('COM_HWDMS_UNPUBLISH');
                ...
                $href = '<a class="jgrid" href="javascript:void(0);" onclick="return listItemTask(\'cb'.$i.'\',\'users.'.$func.'\')" title="'.JText::_($alt).'">';
                $href .= $image.'</a>';
