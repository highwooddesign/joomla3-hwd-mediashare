...
class hwdMediaShareViewCustomField extends JViewLegacy {
	...
	protected function addToolBar()
	{
		...
		JToolBarHelper::title($isNew ? JText::_('COM_HWDMS_NEW_CUSTOM_FIELD') : JText::_('COM_HWDMS_EDIT_CUSTOM_FIELD'), 'hwdmediashare');
	...
	protected function setDocument()
	{
		...
		$document->setTitle($isNew ? JText::_('COM_HWDMS_HWDMEDIASHARE').' '.JText::_('COM_HWDMS_NEW_CUSTOM_FIELD') : JText::_('COM_HWDMS_HWDMEDIASHARE').' '.JText::_('COM_HWDMS_EDIT_CUSTOM_FIELD'));
