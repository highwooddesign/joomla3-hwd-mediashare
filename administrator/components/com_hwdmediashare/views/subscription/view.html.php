...
class hwdMediaShareViewSubscription extends JViewLegacy {
	...
	protected function addToolBar()
	{
		...
		JToolBarHelper::title($isNew ? JText::_('COM_HWDMS_NEW_SUBSCRIPTION') : JText::_('COM_HWDMS_EDIT_SUBSCRIPTION'), 'hwdmediashare');
	...
	protected function setDocument()
	{
		...
		$document->setTitle($isNew ? JText::_('COM_HWDMS_HWDMEDIASHARE').' '.JText::_('COM_HWDMS_NEW_SUBSCRIPTION') : JText::_('COM_HWDMS_HWDMEDIASHARE').' '.JText::_('COM_HWDMS_EDIT_SUBCRIPTION'));
