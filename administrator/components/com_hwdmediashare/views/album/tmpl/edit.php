<?php
/**
 * @version    SVN $Id: edit.php 685 2012-10-24 10:31:07Z dhorsfall $
...
$permissions = $this->form->getFieldsets('permissions');
...
<form action="<?php echo JRoute::_('index.php?option=com_hwdmediashare&layout=edit&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="adminForm" class="form-validate" enctype="multipart/form-data">
	<div class="width-60 fltlft">
                <fieldset class="adminform">
                        <legend><?php echo JText::_( 'COM_HWDMS_ALBUM_DETAILS' ); ?></legend>
		...
		<?php echo JHtml::_('sliders.start', 'hwdmediashare-slider'); ?>
                ...
                <?php echo JHtml::_('sliders.panel', JText::_( 'COM_HWDMS_MEDIA' ), 'media');?>
                        <fieldset class="panelform" >
                                <ul class="adminformlist">
                                        <li>
                                                <label title="<?php echo JText::_( 'COM_HWDMS_MANAGE_MEDIA' ); ?>" class="hasTip" id="jform_managemedia-lbl"><?php echo JText::_( 'COM_HWDMS_ALBUM_MEDIA' ); ?> (<?php echo $this->item->mediacount; ?>)</label>
