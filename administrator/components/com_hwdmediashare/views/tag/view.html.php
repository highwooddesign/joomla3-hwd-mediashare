 ...
 * hwdMediaShare View
 */
class hwdMediaShareViewTag extends JViewLegacy {
	/**
	...
	protected function addToolBar()
	{
		...
		$canDo = hwdMediaShareHelper::getActions($this->item->id, 'tag');
		JToolBarHelper::title($isNew ? JText::_('COM_HWDMS_NEW_TAG') : JText::_('COM_HWDMS_EDIT_TAG'), 'hwdmediashare');
	...
	protected function setDocument()
	{
		...
		$document->setTitle($isNew ? JText::_('COM_HWDMS_HWDMEDIASHARE').' '.JText::_('COM_HWDMS_NEW_TAG') : JText::_('COM_HWDMS_HWDMEDIASHARE').' '.JText::_('COM_HWDMS_EDIT_TAG'));
