<?php
/**
 * @version    SVN $Id: modal.php 1139 2013-02-21 11:09:05Z dhorsfall $
 * @package    hwdMediaShare
 * @copyright  Copyright (C) 2011 Highwood Design Limited. All rights reserved.
 * @license    GNU General Public License http://www.gnu.org/copyleft/gpl.html
 * @author     Dave Horsfall
 * @since      05-Dec-2011 21:46:42
 */
...
$function       = JRequest::getCmd('function', 'jSelectAlbum_album_id');
?>
<form action="<?php echo JRoute::_('index.php?option=com_hwdmediashare'); ?>" method="post" name="adminForm" id="adminForm">
	...
	<div class="clr"> </div>
		...
		<input type="hidden" name="function" value="jSelectAlbum_assign_album_id" />
