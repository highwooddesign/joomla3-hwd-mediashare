...
/**
 * Supports a modal playlist picker.
 *
 * @package     Joomla.Administrator
...
class JFormFieldPlaylist extends JFormField
{
	 ...
	 */
		...
		if ($allowClear && !$scriptClear)
		{
			...
			$script[] = '		document.getElementById(id + "_name").value = "'.htmlspecialchars(JText::_('COM_HWDMS_SELECT_PLAYLIST', true), ENT_COMPAT, 'UTF-8').'";';
