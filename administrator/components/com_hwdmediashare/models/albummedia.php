<?php
/**
 * @version    SVN $Id: albummedia.php 493 2012-08-28 13:20:17Z dhorsfall $
 * @package    hwdMediaShare
 * @copyright  Copyright (C) 2011 Highwood Design Limited. All rights reserved.
 * @license    GNU General Public License http://www.gnu.org/copyleft/gpl.html
 * @author     Dave Horsfall
 * @since      31-Oct-2011 15:56:38
 */
...
class hwdMediaShareModelAlbumMedia extends JModelList
{
	...
	protected function populateState($ordering = null, $direction = null)
	{
		...
		$this->setState('filter.linked', $linked);
                ...
                $album  = JRequest::getInt('album_id','');
                $this->setState('filter.album_id', $album);
        ...
        public function unlink($id, $params)
        {
                ...
                $query = "
                  SELECT id
                    ...
                    WHERE ".$db->quoteName('media_id')." = ".$db->quote($id)." AND ".$db->quoteName('album_id')." = ".$db->quote($params->albumId).";
                  ";
                $db->setQuery($query);
        ...
        public function link($id, $params)
        {
                ...
                $object = new StdClass;
                $object->media_id = $id;
                $object->album_id = $params->albumId;
