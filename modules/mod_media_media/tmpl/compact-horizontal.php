<?php
/**
 * @version    $Id: compact-horizontal.php 986 2013-01-30 09:25:03Z dhorsfall $
      ...
      <div class="system-unpublished">
        ...
        <div class="media-item" style="margin-bottom:20px;">
          ...
          <?php if ($params->get('list_link_thumbnails') == 1) : ?><a href="<?php echo ($params->get('modal') == '1' ? JRoute::_(hwdMediaShareHelperRoute::getMediaModalRoute($item->slug)) : JRoute::_(hwdMediaShareHelperRoute::getMediaItemRoute($item->slug))); ?>" <?php echo ($params->get('modal') == '1' ? 'class="modal" rel="{handler: \'iframe\', size: {x: 100, y: 100}}"' : false); ?>><?php endif; ?>
             <img src="<?php echo JRoute::_(hwdMediaShareDownloads::thumbnail($item, $helper->get('elementType'))); ?>" border="0" alt="<?php echo $helper->get('utilities')->escape($item->title); ?>" <?php echo ($params->get('list_thumbnail_aspect') == 0 ? 'style="max-width:100%;max-height:100px;" ' : ''); ?>class="media-thumb <?php echo ($params->get('list_tooltip_location') > '2' ? 'hasTip' : ''); ?>" title="<?php echo $helper->get('utilities')->escape($item->title); ?>::<?php echo ($params->get('list_tooltip_contents') != '0' ? $helper->get('utilities')->escape(JHtmlString::truncate($item->description, $params->get('list_desc_truncate'), true, false)) : ''); ?>" />
        ...
        <?php if ($params->get('list_meta_title') != 'hide') :?>
          <p title="<?php echo $helper->get('utilities')->escape($item->title); ?>::<?php echo ($params->get('list_tooltip_contents') != '0' ? $helper->get('utilities')->escape(JHtmlString::truncate($item->description, $params->get('list_desc_truncate'), true, false)) : ''); ?>" style="height:25px;overflow:hidden;font-size:11px!important;font-weight:bold;line-height:110%;margin:0!important;">
