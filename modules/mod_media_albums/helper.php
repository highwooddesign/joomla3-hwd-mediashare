...
require_once JPATH_SITE.'/components/com_hwdmediashare/views/albums/view.html.php';

class modMediaAlbumsHelper extends hwdMediaShareViewAlbums
{
	...
	public function getItems()
	{
		...
		$app = JFactory::getApplication();
                ...
                $this->_model->context = 'mod_media_albums';
