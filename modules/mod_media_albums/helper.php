...
class modMediaAlbumsHelper extends JObject {
	...
	public function __construct($module, &$params)
	{
		...
		$this->set('url', JURI::root().'modules/mod_media_albums/');
		$this->set('container', 'modmediaalbums_'.$module->id);
                $this->set('return', base64_encode(JFactory::getURI()->toString()));
                $this->set('columns', $params->get('list_columns', 3));
                $this->set('elementType', 2);
                $this->set('elementName', 'Album');
        }
	...
	public function getItems()
	{
                ...
                //$model =& JModel::getInstance('Albums', 'hwdMediaShareModel', array('ignore_request' => true));
                ...
                $model = ($version->RELEASE >= 3.0 ? JModelLegacy::getInstance('Albums', 'hwdMediaShareModel', array('ignore_request' => true)) : JModel::getInstance('Albums', 'hwdMediaShareModel', array('ignore_request' => true)));
		...
		// Ordering
		$model->setState('com_hwdmediashare.albums.list.ordering', $this->params->get('ordering', 'a.ordering'));
		$model->setState('com_hwdmediashare.albums.list.direction', $this->params->get('ordering_direction', 'ASC'));
