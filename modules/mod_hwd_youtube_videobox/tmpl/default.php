...
<?php foreach ($items as $id => &$item) : ?>
  ...
  <div class="cell col-xs-6 col-sm-4 col-md-<?php echo intval(12/$params->get('columns', 5)); ?>">
    <!-- Thumbnail Image -->
    <div class="media-item hasHwdTip" title="<?php echo htmlspecialchars($item->title); ?>::<?php echo htmlspecialchars(JHtmlString::truncate($item->description, 300, true, false)); ?>">
    ...
    <div class="clear"></div>
    <!-- Item Meta -->
    <?php if ($params->get('videos_show_videos_category') != 'hide'):?><span class="small badge pull-right"><?php echo $item->category; ?></span><?php endif; ?>
