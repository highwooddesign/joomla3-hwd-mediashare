...
class modMediaActivitiesHelper extends JObject
{
	...
	public function __construct($module, &$params)
	{
		...
		$this->set('url', JURI::root().'modules/mod_media_activities/');
		$this->set('container', 'modmediaactivities_'.$module->id);
	...
	public function getItems()
	{
                ...
                //$model =& JModel::getInstance('Activities', 'hwdMediaShareModel', array('ignore_request' => true));
                ...
                $model = ($version->RELEASE >= 3.0 ? JModelLegacy::getInstance('Activities', 'hwdMediaShareModel', array('ignore_request' => true)) : JModel::getInstance('Activities', 'hwdMediaShareModel', array('ignore_request' => true)));
		...
		// Ordering
		$model->setState('com_hwdmediashare.activities.list.ordering', $this->params->get('ordering', 'a.created'));
		$model->setState('com_hwdmediashare.activities.list.direction', $this->params->get('ordering_direction', 'ASC'));
