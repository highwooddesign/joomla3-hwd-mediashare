...
class modMediaGroupsHelper extends JObject {
	...
	public function __construct($module, &$params)
	{
		...
		$this->set('url', JURI::root().'modules/mod_media_groups/');
		$this->set('container', 'modmediagroups_'.$module->id);
                $this->set('return', base64_encode(JFactory::getURI()->toString()));
                $this->set('columns', $params->get('list_columns', 3));
                $this->set('elementType', 3);
	}
	...
	public function getItems()
	{
                ...
                //$model =& JModel::getInstance('Groups', 'hwdMediaShareModel', array('ignore_request' => true));
                ...
                $model = ($version->RELEASE >= 3.0 ? JModelLegacy::getInstance('Groups', 'hwdMediaShareModel', array('ignore_request' => true)) : JModel::getInstance('Groups', 'hwdMediaShareModel', array('ignore_request' => true)));
		...
		// Ordering
		$model->setState('com_hwdmediashare.groups.list.ordering', $this->params->get('ordering', 'a.ordering'));
		$model->setState('com_hwdmediashare.groups.list.direction', $this->params->get('ordering_direction', 'ASC'));
