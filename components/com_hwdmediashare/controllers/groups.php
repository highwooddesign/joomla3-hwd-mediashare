<?php
/**
 * @version    SVN $Id: groups.php 1603 2013-06-25 12:45:12Z dhorsfall $
 * @package    hwdMediaShare
 * @copyright  Copyright (C) 2011 Highwood Design Limited. All rights reserved.
 * @license    GNU General Public License http://www.gnu.org/copyleft/gpl.html
 * @author     Dave Horsfall
 * @since      27-Nov-2011 17:14:45
 */
...
class hwdMediaShareControllerGroups extends JControllerForm
{
	...
	function delete()
	{
		...
		foreach ($ids as $i => $id)
		{
			...
			if (!($user->authorise('core.edit.state', 'com_hwdmediashare.group.'.$item->id) || ($user->authorise('core.edit.own', 'com_hwdmediashare') && ($item->created_user_id == $user->id)))) 
                        {
				// Prune items that you can't change.
				unset($ids[$i]);
				JError::raiseNotice(403, JText::_('JLIB_APPLICATION_ERROR_EDITSTATE_NOT_PERMITTED'));
