<?php
/**
 * @version    SVN $Id: categories.php 1605 2013-06-25 12:46:35Z dhorsfall $
 * @package    hwdMediaShare
 * @copyright  Copyright (C) 2011 Highwood Design Limited. All rights reserved.
 * @license    GNU General Public License http://www.gnu.org/copyleft/gpl.html
 * @author     Dave Horsfall
 * @since      27-Nov-2011 17:22:33
 */
...
class hwdMediaShareControllerCategories extends JControllerForm
{
	 ...
	 * @return	hwdMediaShareControllerCategories
	 * @see		JController
	 * @since	0.1
	 */
	...
	function delete()
	{
		...
		foreach ($ids as $i => $id)
		{
			if (!$user->authorise('core.delete', 'com_hwdmediashare.category.'.(int) $id)) 
                        {
				// Prune items that you can't change.
				unset($ids[$i]);
				JError::raiseNotice(403, JText::_('JLIB_APPLICATION_ERROR_EDITSTATE_NOT_PERMITTED'));
