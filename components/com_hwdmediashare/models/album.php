<?php
/**
 * @version    SVN $Id: album.php 1593 2013-06-14 13:34:07Z dhorsfall $
 * @package    hwdMediaShare
 * @copyright  Copyright (C) 2011 Highwood Design Limited. All rights reserved.
 * @license    GNU General Public License http://www.gnu.org/copyleft/gpl.html
 * @author     Dave Horsfall
 * @since      26-Oct-2011 17:14:11
 */
...
class hwdMediaShareModelAlbum extends JModelList
{
	 ...
	 * @var		string
	 */
	public $_context = 'com_hwdmediashare.album';
	 ...
	 */
	public function getTable($type = 'Album', $prefix = 'hwdMediaShareTable', $config = array())
	{
        ...
        /**
	 * Method to get a single album record.
	 *
	...
	public function getAlbum($pk = null)
	{
                ...
                if (empty($pk)) {
                        $pk = $this->getState('filter.album_id');
                }
                ...
                {                    
                        ...
                        $this->_album->tags = hwdMediaShareTags::getInput($this->_album);
                        hwdMediaShareFactory::load('customfields');
                        $this->_album->customfields = hwdMediaShareCustomFields::get($this->_album);

                        // Add data to object
                        if ($this->_album->created_user_id > 0)
                        {   
                                if (!empty($this->_album->created_user_id_alias))
                                { 
                                        $this->_album->author = $this->_album->created_user_id_alias;
                                }
                                else
                                {
                                        $user = & JFactory::getUser($this->_album->created_user_id);
                                        $config->get('author') == 0 ? $this->_album->author = $user->name : $this->_album->author = $user->username;
                                }
                        }
                        else
                        {
	...
	public function getItems($pk = null)
	{
		...
		$model->setState('params', $appParams);
                ...
                // Set other filters
                $model->setState('filter.album_id', $this->getState('filter.album_id'));
		...
		$this->setState('filter.search', $search);
                ...
                $listOrder = $app->getUserStateFromRequest($this->_context.'.list.ordering', 'filter_order', JRequest::getCmd('filter_order', $this->_album->params->get('list_order_media', $config->get('list_order_media', 'a.created'))));
	...
	public function like()
	{
            ...
            JFactory::getApplication()->enqueueMessage( JText::_('COM_HWDMS_NOTICE_ALBUM_LIKED') );
            return true;
	}
	...
	public function dislike()
	{
            ...
            JFactory::getApplication()->enqueueMessage( JText::_('COM_HWDMS_NOTICE_ALBUM_DISLIKED') );
            return true;
	}
