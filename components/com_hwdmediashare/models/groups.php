<?php
/**
 * @version    SVN $Id: groups.php 1705 2013-10-17 14:22:30Z dhorsfall $
 * @package    hwdMediaShare
 * @copyright  Copyright (C) 2011 Highwood Design Limited. All rights reserved.
 * @license    GNU General Public License http://www.gnu.org/copyleft/gpl.html
 * @author     Dave Horsfall
 * @since      16-Nov-2011 19:28:42
 */
...
class hwdMediaShareModelGroups extends JModelList
{
	 ...
	 * @var		string
	 */
	public $_context = 'com_hwdmediashare.groups';
	...
	protected function populateState()
	{
		...
		// Load the parameters.
                ...
                $listOrder = $app->getUserStateFromRequest($this->_context.'.list.ordering', 'filter_order', JRequest::getCmd('filter_order', $config->get('list_order_group', 'a.created')));
		...
		// Set HWD listing states
                $limit = $app->getUserStateFromRequest($this->context . '.global.list.limit', 'limit', $config->get('list_limit', $app->getCfg('list_limit') )); // Get global list limit from request, with default value read from HWD configuration and fallback to global Joomla value
