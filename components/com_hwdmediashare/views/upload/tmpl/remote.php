...
<form action="<?php echo JRoute::_('index.php?option=com_hwdmediashare'); ?>" method="post" name="adminForm" id="adminForm" class="form-validate" enctype="multipart/form-data">
  <div id="hwd-container" class="<?php echo $this->pageclass_sfx;?>"> <a name="top" id="top"></a>
    ...
    <div class="media-header">
      <a title="<?php echo JText::_('COM_HWDMS_ADD_MEDIA'); ?>" href="<?php echo JRoute::_(hwdMediaShareHelperRoute::getUploadRoute(array('method' => 'local'))); ?>" class="btn pull-right media-upload-switch"><?php echo JText::_('COM_HWDMS_BTN_UPLOAD_SWITCH_ADD_LOCAL'); ?></a>
      ...
      <div class="row-fluid">
        ...
        <div class="span4">
          ...
          <div class="btn-toolbar row-fluid">
            <button type="button" class="btn btn-primary btn-large span12" onclick="Joomla.submitbutton('addmedia.remote')">
              <?php echo JText::_('COM_HWDMS_ADD') ?>
            </button>
          </div>            
          <?php if ($this->config->get('upload_workflow') == 1) : ?>
            <p><?php echo JText::_('COM_HWDMS_ADD_MULTIPLE_REMOTE_MEDIA_DESC'); ?></p>
          <?php endif; ?>  
        </div>
      </div>  
    </fieldset>     
