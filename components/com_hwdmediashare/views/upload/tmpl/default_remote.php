    ...
    <fieldset>
      <div class="row-fluid">
        ...
        <div class="span4">
          ...
          <div class="btn-toolbar row-fluid">
            <a title="<?php echo JText::_('COM_HWDMS_ADD_MEDIA'); ?>" href="<?php echo JRoute::_(hwdMediaShareHelperRoute::getUploadRoute(array('method' => 'local'))); ?>" class="btn span12">or select files to upload</a>
          </div>             
        </div>
      </div>  
    </fieldset>     
