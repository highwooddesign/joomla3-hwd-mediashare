<?php
/**
 * @version    SVN $Id: view.html.php 1214 2013-03-05 13:30:33Z dhorsfall $
 * @package    hwdMediaShare
 * @copyright  Copyright (C) 2011 Highwood Design Limited. All rights reserved.
 * @license    GNU General Public License http://www.gnu.org/copyleft/gpl.html
 * @author     Dave Horsfall
 * @since      14-Nov-2011 20:55:42
 */
...
class hwdMediaShareViewAlbums extends JViewLegacy {
	...
	function display($tpl = null)
	{
		...
		if (count($errors = $this->get('Errors')))
			...
			return false;
                ...
                if (count($items) == 0)
                {
                        JFactory::getApplication()->enqueueMessage( JText::_('COM_HWDMS_NOTICE_NO_ALBUMS') );
                }
	...
	protected function _prepareDocument()
	{
		...
		{
			$this->params->def('page_heading', JText::_('COM_HWDMS_ALBUMS'));
		}
