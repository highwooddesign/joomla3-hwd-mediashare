<?php
/**
 * @version    SVN $Id: view.html.php 1219 2013-03-05 13:31:59Z dhorsfall $
 * @package    hwdMediaShare
 * @copyright  Copyright (C) 2011 Highwood Design Limited. All rights reserved.
 * @license    GNU General Public License http://www.gnu.org/copyleft/gpl.html
 * @author     Dave Horsfall
 * @since      14-Nov-2011 20:51:40
 */
...
class hwdMediaShareViewPlaylists extends JViewLegacy {
    	protected $view_item = 'playlist';
        protected $elementType = 4;
        protected $elementName = 'Playlist'; 
	...
	function display($tpl = null)
	{
		...
		if (count($errors = $this->get('Errors')))
			...
			return false;
                ...
                if (count($items) == 0)
                {
                        JFactory::getApplication()->enqueueMessage( JText::_('COM_HWDMS_NOTICE_NO_PLAYLISTS') );
                }
