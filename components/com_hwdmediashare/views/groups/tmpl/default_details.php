<?php
/**
 * @version    SVN $Id: default_details.php 1709 2013-10-17 14:27:40Z dhorsfall $
...
$listOrder	= $this->escape($this->state->get('com_hwdmediashare.groups.list.ordering'));
$listDirn	= $this->escape($this->state->get('com_hwdmediashare.groups.list.direction'));
