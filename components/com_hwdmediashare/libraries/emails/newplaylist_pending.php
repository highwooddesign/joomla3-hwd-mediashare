...
<br>
<br>
A new playlist was <?php echo JText::sprintf('COM_HWDMS_CREATED_ON', JHtml::_('date', $row->created, $config->get('list_date_format'))); ?>.<br>
<br>
Playlist name: <?php echo $row->title; ?><br>
Description: <?php echo $row->description; ?><br>
<?php echo JText::sprintf('COM_HWDMS_CREATED_BY', $user->username);?><br>
<br>
This playlist is pending. You need to check this item for approval:<br>
<?php echo $linkPending; ?><br>
<br>
View this playlist in the administrator:<br>
