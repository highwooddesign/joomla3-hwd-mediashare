...
<br>
<br>
A new album was <?php echo JText::sprintf('COM_HWDMS_CREATED_ON', JHtml::_('date', $row->created, $config->get('list_date_format'))); ?>.<br>
<br>
Album name: <?php echo $row->title; ?><br>
Description: <?php echo $row->description; ?><br>
<?php echo JText::sprintf('COM_HWDMS_CREATED_BY', $user->username);?><br>
<br>
This album is pending. You need to check this item for approval:<br>
<?php echo $linkPending; ?><br>
<br>
View this album in the administrator:<br>
