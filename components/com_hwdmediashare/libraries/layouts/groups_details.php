...
<?php endif; ?>
  ...
  <div class="span<?php echo intval(12/$displayData->columns); ?>">
    ...
    <!-- Clears Item and Information -->
    <div class="clear"></div>
    <?php if ($displayData->params->get('list_meta_description') != 'hide' || $displayData->params->get('list_meta_author') != 'hide' || $displayData->params->get('list_meta_created') != 'hide' || $displayData->params->get('list_meta_likes') != 'hide' || $displayData->params->get('list_meta_hits') != 'hide') : ?>
    <!-- Item Meta -->
    <dl class="media-info">
      ...
      <?php endif; ?>
      <?php if ($displayData->params->get('list_meta_description') != 'hide') :?>
