...
<?php endif; ?>
  ...
  <div class="span<?php echo intval(12/$displayData->columns); ?>">
    ...
    <!-- Clears Item and Information -->
    <div class="clear"></div>
    <?php if ($displayData->params->get('list_meta_description') != '0' || $displayData->params->get('list_meta_author') != '0' || $displayData->params->get('list_meta_created') != '0' || $displayData->params->get('list_meta_likes') != '0' || $displayData->params->get('list_meta_hits') != '0') : ?>
    <!-- Item Meta -->
    <dl class="media-info">
