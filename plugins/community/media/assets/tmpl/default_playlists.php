<?php
/**
 * @version    SVN $Id: default_playlists.php 425 2012-06-28 07:48:57Z dhorsfall $
    ...
    <div class="item column-<?php echo $rowcount;?><?php echo ($item->published != '1' ? ' system-unpublished' : false); ?>">
      ...
      <div class="system-unpublished">
        ...
        <?php if ($this->params->get('list_meta_title') != 'hide') :?>
          <h2 class="contentheading"> <a href="<?php echo JRoute::_(hwdMediaShareHelperRoute::getPlaylistRoute($item->slug)); ?>"> <?php echo $this->utilities->escape(JHtmlString::truncate($item->title, $this->params->get('list_title_truncate'))); ?> </a> </h2>
        <?php endif; ?>
        <!-- Thumbnail Image -->
        <div class="media-item">
          ...
          <a href="<?php echo JRoute::_(hwdMediaShareHelperRoute::getPlaylistRoute($item->slug)); ?>">
             <img src="<?php echo JRoute::_(hwdMediaShareDownloads::thumbnail($item, $this->elementType)); ?>" border="0" alt="<?php echo $this->utilities->escape($item->title); ?>" style="max-width:100%;" />
          </a>
          <?php endif; ?>
        </div>
        ...
        <dl class="article-info">
          ...
          <?php if ($this->params->get('list_meta_likes') != 'hide') :?>
            <dd class="media-info-like"> <a href="<?php echo JRoute::_('index.php?option=com_hwdmediashare&task='.$this->view_item.'.like&id=' . $item->id . '&return=' . $this->return . '&tmpl=component'); ?>"><?php echo JText::_('COM_HWDMS_LIKE'); ?></a> (<?php echo $this->utilities->escape($item->likes); ?>) <a href="<?php echo JRoute::_('index.php?option=com_hwdmediashare&task='.$this->view_item.'.dislike&id=' . $item->id . '&return=' . $this->return . '&tmpl=component'); ?>"><?php echo JText::_('COM_HWDMS_DISLIKE'); ?></a> (<?php echo $this->utilities->escape($item->dislikes); ?>) </dd>
          <?php endif; ?>
