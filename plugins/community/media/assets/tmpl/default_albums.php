<?php
/**
 * @version    SVN $Id: default_albums.php 425 2012-06-28 07:48:57Z dhorsfall $
    ...
    <div class="item column-<?php echo $rowcount;?><?php echo ($item->published != '1' ? ' system-unpublished' : false); ?>">
      ...
      <div class="system-unpublished">
        ...
        <?php if ($this->params->get('list_meta_title') != 'hide') :?>
          <h2 class="contentheading"> <a href="<?php echo JRoute::_(hwdMediaShareHelperRoute::getAlbumRoute($item->slug)); ?>"> <?php echo $this->utilities->escape(JHtmlString::truncate($item->title, $this->params->get('list_title_truncate'))); ?> </a> </h2>
        <?php endif; ?>
        <!-- Thumbnail Image -->
