<?php
/**
 * @version    SVN $Id: default_favourites.php 425 2012-06-28 07:48:57Z dhorsfall $
      ...
      <div class="system-unpublished">
        ...
        <?php if ($this->params->get('list_meta_title') != 'hide') :?>
          <h<?php echo $this->params->get('list_item_heading'); ?> class="contentheading">
            <?php if ($this->params->get('list_link_titles') != 0) :?><a href="<?php echo JRoute::_(hwdMediaShareHelperRoute::getMediaItemRoute($item->slug)); ?>"><?php endif; ?>
