<?php
/**
 * @version    $Id: remote_yahoocom.php 509 2012-09-19 14:23:44Z dhorsfall $
...
/**
 * hwdMediaShare Fox.com remote plugin class
 *
 * @package hwdMediaShare
 * @since   1.0.5
 */
class plgHwdmediashareRemote_videofoxnewscom extends JObject
{
	/**
	 ...
	 *
	 * @return  plgHwdmediashareRemote_videofoxnewscom A plgHwdmediashareRemote_videofoxnewscom object.
	 * @since   0.1
	 */
	...
	public function getTitle()
	{
                if( !$this->_title )
		{
                        ...
                        $this->_title = str_replace(" | Fox.com", "", $this->_title);
                }
                return $this->_title;
        }
	...
	public function getDuration()
	{
                if( !$this->_duration )
		{
                        ...
                        preg_match('/<strong itemprop="duration" content="([^"]+)/', $this->_buffer, $match);
                        if (!empty($match[1]))
                        {
	...
	public function display($item)
	{
		...
		$params = new JParameter( @$plugin->params );
                ...
                $id = plgHwdmediashareRemote_videofoxnewscom::parse($item->source);
                ob_start();
                ?>
                <script type="text/javascript" src="http://video.foxnews.com/v/embed.js?id=<?php echo $id; ?>&w=<?php echo $this->width; ?>&h=<?php echo $this->height; ?>"></script><noscript>Watch the latest video at <a href="http://video.foxnews.com">video.foxnews.com</a></noscript>
                <?php
