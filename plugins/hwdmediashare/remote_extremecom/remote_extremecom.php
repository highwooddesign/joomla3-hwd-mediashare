...
/**
 * @package     Joomla.site
 * @subpackage  Plugin.hwdmediashare.remote_extremecom
 *
...
class plgHwdmediashareRemote_extremecom extends hwdMediaShareRemote
{    
	/**
	...
	/**
	 * Returns the plgHwdmediashareRemote_extremecom object, only creating it if it
	 * doesn't already exist.
	 *
	 * @access  public
	 * @return  object  The plgHwdmediashareRemote_extremecom object.
	 */
	public static function getInstance()
	{
		...
		if (!isset ($instance))
                {
			$c = 'plgHwdmediashareRemote_extremecom';
                        $instance = new $c;
		}
	...
	public function getDirectDisplayLocation($item)
	{
		...
		$plugin = JPluginHelper::getPlugin('hwdmediashare', 'remote_extremecom');
                ...
                {             
                        ...
                        return JURI::getInstance()->getScheme() .'://player.extreme.com/FCPlayer.swf?id=' . $embedLookup . '?autostart=' . $this->autoplay . '&amp;player_id=extreme';
                }
        }  
