...
/**
 * @package     Joomla.site
 * @subpackage  Plugin.hwdmediashare.remote_wattv
 *
...
class plgHwdmediashareRemote_wattv extends hwdMediaShareRemote
{    
	/**
	...
	/**
	 * Returns the plgHwdmediashareRemote_wattv object, only creating it if it
	 * doesn't already exist.
	 *
	 * @access  public
	 * @return  object  The plgHwdmediashareRemote_wattv object.
	 */
	public static function getInstance()
	{
		...
		if (!isset ($instance))
                {
			$c = 'plgHwdmediashareRemote_wattv';
                        $instance = new $c;
		}
	...
	public function display($item)
	{
		// Initialise variables.
                ...
                // Load plugin.
		$plugin = JPluginHelper::getPlugin('hwdmediashare', 'remote_wattv');
		
                // Load the language file.
                $lang = JFactory::getLanguage();
                $lang->load('plg_hwdmediashare_remote_wattv', JPATH_ADMINISTRATOR, $lang->getTag());

                if (!$plugin)
                {
                        $this->setError(JText::_('PLG_HWDMEDIASHARE_REMOTE_WATTV_ERROR_NOT_PUBLISHED'));
                        return false;
                }
