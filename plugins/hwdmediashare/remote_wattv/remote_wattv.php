<?php
/**
 * @version    $Id: remote_wattv.php 509 2012-09-19 14:23:44Z dhorsfall $
...
/**
 * hwdMediaShare wat.com remote plugin class
 *
 * @package hwdMediaShare
 * @since   1.0.5
 */
class plgHwdmediashareRemote_wattv extends JObject
{
	/**
	 ...
	 *
	 * @return  plgHwdmediashareRemote_wattv A plgHwdmediashareRemote_wattv object.
	 * @since   0.1
	 */
	...
	public function display($item)
	{
                ...
                $src = $this->parse($item->source);

                ob_start();
                ?>
                <iframe src="<?php echo $src; ?>" frameborder="0" style="width:<?php echo $this->width; ?>px; height: <?php echo $this->height; ?>px;"></iframe>
                <?php
	 ...
	 **/
        public function parse($url)
        {
                ...
                preg_match('/<meta property="og:video" content="([^"]+)/', $buffer, $match);
                if (!empty($match[1]))
                {
                        return $match[1];
                }
